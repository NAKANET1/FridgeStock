...
<div className="min-h-screen flex flex-col bg-gray-50 overflow-x-hidden">
  <main className="flex-1 px-6 pt-6 pb-32"> {/* pxを6に増やして左右余白 */}
    <h1 className="text-xl font-bold mb-8 text-center">マイページ</h1> {/* mbを8に */}

    <div className="max-w-md mx-auto bg-white p-6 rounded-2xl shadow-md space-y-6"> {/* space-y-6で子要素間余白 */}
      ...
      {/* ボタン */}
      <div className="flex flex-col gap-4 mt-6"> {/* gapを4、mtを6に */}
        <button
          onClick={handleEdit}
